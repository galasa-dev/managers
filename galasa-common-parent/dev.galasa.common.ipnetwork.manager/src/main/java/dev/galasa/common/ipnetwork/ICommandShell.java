package dev.galasa.common.ipnetwork;

import dev.galasa.common.ipnetwork.internal.ssh.SSHException;
...
public interface ICommandShell {
	 ...
	 * @throws SSHException
	 */
	public String issueCommand(String command, boolean newShell, long timeout)
			throws IpNetworkManagerException;
...
//	public void changeUser(String userid, String password);
	 ...
	 * - not valid for Rexec implementation
	 * - equivalent to {@link #issueCommand(String, boolean, long)} for Telnet implementation
	 * 
	 * @param command
	 *            - command to issue
	 * @return the output of the command (stdout and stderr)
