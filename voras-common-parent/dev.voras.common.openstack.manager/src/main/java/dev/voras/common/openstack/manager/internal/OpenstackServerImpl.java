...
public class OpenstackServerImpl {
	...
	public static void deleteServerByName(String serverName, 
			...
			OpenstackProperties openstackProperties) throws OpenstackManagerException {
		...
		deleteServer(server, serverName, runName, dss, openstackHttpClient, openstackProperties);
	}
