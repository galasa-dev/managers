...
@PrepareForTest({ZosConsoleZosmfPropertiesSingleton.class, CpsProperties.class})
public class TestRestrictToImage {
    ...
    private boolean getProperty(String value, boolean exception) throws Exception {
        PowerMockito.spy(ZosConsoleZosmfPropertiesSingleton.class);
        PowerMockito.doReturn(configurationPropertyStoreServiceMock).when(ZosConsoleZosmfPropertiesSingleton.class, "cps");
