...
public class TestProgramLanguageCompileSyslibs {
    ...
    public void testConstructor() {
        ProgramLanguageCompileSyslibs programLanguageCompileSyslibs = new ProgramLanguageCompileSyslibs();
        Assert.assertNotNull("Object was not created", programLanguageCompileSyslibs);
    }
    
    @Test
    public void testEmpty() throws Exception {
        Assert.assertEquals("Unexpected value returned from ProgramLanguageCompileSyslibs.get()", Collections.emptyList(), getProperty(Collections.emptyList(), Language.COBOL));
    }
    
    @Test
    public void testValid() throws Exception {
        Assert.assertEquals("Unexpected value returned from ProgramLanguageCompileSyslibs.get()", PREFIX_LIST, getProperty(PREFIX_LIST, Language.COBOL));
    }
    
    @Test
    public void testException() throws Exception {
        exceptionRule.expect(ZosProgramManagerException.class);
        exceptionRule.expectMessage("Problem asking the CPS for the zOS program COBOL custom compile syslibs for zOS image " + IMAGE_ID);
    ...
    private List<String> getProperty(List<String> prefixList, Language language, boolean exception) throws Exception {
        ...
        return ProgramLanguageCompileSyslibs.get(IMAGE_ID, language);
    }
}
