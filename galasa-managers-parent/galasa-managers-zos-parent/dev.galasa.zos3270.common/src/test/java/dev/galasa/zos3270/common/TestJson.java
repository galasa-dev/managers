...
public class TestJson {
    ...
    public void testWriteAndReadJson() {
        ...
        TerminalField field = new TerminalField(posRow, posColumn, false, true, true, true, true, true, true);
        ...
        String tempJson = gson.toJson(terminal);
        ...
        assertThat(testField.isFieldNumeric()).isTrue();
