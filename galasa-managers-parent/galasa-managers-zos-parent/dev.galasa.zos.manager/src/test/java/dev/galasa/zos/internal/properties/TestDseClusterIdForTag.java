...
public class TestDseClusterIdForTag {
    ...
    public void testConstructor() {
        DseClusterIdForTag dseClusterIdForTag = new DseClusterIdForTag();
        Assert.assertNotNull("Object was not created", dseClusterIdForTag);
    }
    
    @Test
    public void testNull() throws Exception {        
        Assert.assertEquals("Unexpected value returned from DseClusterIdForTag.get()", null, getProperty(null));
    }
    
    @Test
    public void testValid() throws Exception {
        Assert.assertEquals("Unexpected value returned from DseClusterIdForTag.get()", TAG, getProperty(TAG));
    }
    
    @Test
    public void testException() throws Exception {
        exceptionRule.expect(ZosManagerException.class);
        exceptionRule.expectMessage("Problem asking the CPS for the DSE cluster id for tag 'ANY'");
    ...
    private String getProperty(String value, boolean exception) throws Exception {
        ...
        return DseClusterIdForTag.get(value);
    }
}
