...
public class TestUNIXCommandExtraBundle {
    ...
    public void testConstructor() {
        UNIXCommandExtraBundle unixCommandExtraBundle = new UNIXCommandExtraBundle();
        Assert.assertNotNull("Object was not created", unixCommandExtraBundle);
    }
    
    @Test
    public void testValid() throws Exception {
        Assert.assertEquals("Unexpected value returned from UNIXCommandExtraBundle.get()", DEFAULT_EXTRA_BUNDLE_UNIX_COMMAND_MANAGER, getProperty(null));
        Assert.assertEquals("Unexpected value returned from UNIXCommandExtraBundle.get()", BUNDLE_EXTRA_MANAGER, getProperty(BUNDLE_EXTRA_MANAGER));
    }
    
    @Test
    public void testException() throws Exception {
        exceptionRule.expect(ZosManagerException.class);
        exceptionRule.expectMessage("Problem asking CPS for the zOS UNIX Command Manager extra bundle name");
    ...
    private String getProperty(String value, boolean exception) throws Exception {
        ...
        return UNIXCommandExtraBundle.get();
    }
}
