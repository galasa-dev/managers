...
public class TestZosmfZosBatchManagerImpl {
    ...
    public void testStartOfTestMethod() throws Exception {
        ...
        Assert.assertEquals("currentTestMethodArchiveFolderName should contain the supplied value", DummyTestClass.class.getDeclaredMethod("dummyTestMethod").getName(), ZosmfZosBatchManagerImpl.currentTestMethodArchiveFolderName);
        ...
        Assert.assertEquals("currentTestMethodArchiveFolderName should contain the supplied value", DummyTestClass.class.getDeclaredMethod("dummyTestMethod").getName() + "." + DummyTestClass.class.getDeclaredMethod("dummyBeforeMethod").getName(), ZosmfZosBatchManagerImpl.currentTestMethodArchiveFolderName);
    }
    ...
    public void testNewZosBatchJobname() throws Exception {
        ...
        IZosBatchJobname zosBatchJobname = ZosmfZosBatchManagerImpl.newZosBatchJobname("image");
