...
public class TestServerHostname {
    ...
    public void testNull() throws Exception {
        ...
        exceptionRule.expectMessage("Value for zOSMF server hostname not configured for zOS image "  + IMAGE_ID);
    ...
    public void testException() throws Exception {
        exceptionRule.expect(ZosmfManagerException.class);
        exceptionRule.expectMessage("Problem asking the CPS for the zOSMF server hostname property for zOS image " + IMAGE_ID);
