 ...
 * @galasa.description
 * 
 * This Manager is the internal implementation of the zOS TSO Command Manager using SSH.<br><br>
 * See the <a href="../zos-manager">zOS Manager</a> for details of the z/OS TSO annotations and 
