...
public interface ICeci {
     ...
     */
    public ICeciResponse issueCommand(@NotNull String command) throws CeciException;
     ...
     * @throws CeciException 
     */
    public ICeciResponse issueCommand(@NotNull String command, boolean parseOutput) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariableText(@NotNull String name, @NotNull String value) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariableBinary(@NotNull String name, @NotNull char[] value) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariableDoubleWord(@NotNull String name, @NotNull long value) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariableFullWord(@NotNull String name, @NotNull int value) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariableHalfWord(@NotNull String name, @NotNull int value) throws CeciException;
     ...
     * @throws CeciException
     */
    public int defineVariablePacked(@NotNull String name, @NotNull int value) throws CeciException;
     ...
     * @throws CeciException
     */
    public String retrieveVariableText(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public char[] retrieveVariableBinary(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public long retrieveVariableDoubleWord(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public int retrieveVariableFullWord(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public int retrieveVariableHalfWord(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public int retrieveVariablePacked(@NotNull String name) throws CeciException;
     ...
     * @throws CeciException
     */
    public void deleteVariable(@NotNull String name) throws CeciException;

    /**
     * Delete all variables in this CECI session.
     * @throws CeciException
     */
    public void deleteAllVariables() throws CeciException;
     ...
     * @throws CeciException
     */
    public IExecInterfaceBlock getEIB() throws CeciException;
     ...
     * @throws CeciException
     */
    public ICeciResponse linkProgram(@NotNull String programName, String commarea, String sysid, String transid, boolean synconreturn) throws CeciException;
     ...
     */
    public ICeciResponse linkProgramWithChannel(@NotNull String programName, @NotNull String channelName, String sysid, String transid, boolean synconreturn) throws CeciException;
     ...
     * @throws CeciException
     */
    public ICeciResponse putContainer(@NotNull String channelName, @NotNull String containerName, @NotNull String content, String dataType, String fromCcsid, String fromCodepage) throws CeciException;
     ...
     * @throws CeciException
     */
    public ICeciResponse getContainer(@NotNull String channelName, @NotNull String containerName, @NotNull String variableName, String intoCcsid, String intoCodepage) throws CeciException;
